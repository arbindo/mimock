...
class MockManagementControllerTest {
    ...
    void shouldReturnHttpOk_ArchiveMockByIdApi_ReturnsArchivedMock() throws Exception {
        ...
        lenient().when(mockManagementService.archiveMock(mockId)).thenReturn(archivedMock);
    ...
    void shouldReturnHttpBadRequest_ArchiveMockByIdApi_ReturnsNull() throws Exception {
        ...
        lenient().when(mockManagementService.archiveMock(mockId)).thenReturn(null);
    ...
    void shouldReturnHttpOk_UnarchiveMockByIdApi_ReturnsUnarchivedMock() throws Exception {
        ...
        lenient().when(mockManagementService.unarchiveMock(mockId)).thenReturn(unarchivedMock);
    ...
    void shouldReturnHttpBadRequest_UnarchiveMockByIdApi_ReturnsNull() throws Exception {
        ...
        lenient().when(mockManagementService.unarchiveMock(mockId)).thenReturn(null);
